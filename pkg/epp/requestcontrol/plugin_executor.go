...
func executePluginsAsDAG(plugins []fwkrc.DataProducer, ctx context.Context, request *fwksched.InferenceRequest, endpoints []fwksched.Endpoint) error {
...
func prepareDataPluginsWithTimeout(timeout time.Duration, plugins []fwkrc.DataProducer,
	ctx context.Context, request *fwksched.InferenceRequest, endpoints []fwksched.Endpoint) error {
