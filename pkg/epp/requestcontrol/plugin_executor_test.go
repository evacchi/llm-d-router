...
func TestPrepareDataPluginsWithTimeout(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			err := prepareDataPluginsWithTimeout(tc.timeout, tc.plugins, ctx, &fwksched.InferenceRequest{}, nil)
...
func TestExecutePluginsAsDAG(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			err := executePluginsAsDAG(tc.plugins, context.Background(), &fwksched.InferenceRequest{}, nil)
